...
### Agents
- [LangChain Agents in production webinar (YouTube)](https://www.youtube.com/watch?v=k8GNCCs16F4)
...
- [How to build a vector database using Weaviate (YouTube)](https://www.youtube.com/watch?v=6hdEJdHWXRE)
- [LangChain output parsing and extraction (YouTube)](https://www.youtube.com/watch?v=fLn-WqliEQU)
- [Document retrieval with LangChain & Pinecone by James Briggs (YouTube)](https://www.youtube.com/watch?v=kvdVduIJsc8&list=WL&index=5)
- [LlamaIndex x LangChain Tutorial (YouTube)](https://www.youtube.com/watch?v=ojQ3hpG_4J8)
- [LangChain prompting tutorial (YouTube)](https://www.youtube.com/watch?v=T6c_XsyaNSQ)
- [How to create a custom tool in LangChain (YouTube)](https://www.youtube.com/watch?v=E0OkxfIJo-0)
...
- [LangChain Course (by Activeloop)](https://learn.activeloop.ai/courses/take/langchain)
- [Full Stack Deep Learning LLM Discord Bot (code)](https://github.com/the-full-stack/ask-fsdl)
